  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="w-[360px] rounded-2xl px-6 py-8">
        ...
        <AlertDialogFooter className="mt-6 flex justify-center space-x-4">
          <AlertDialogCancel className="rounded-md bg-gray-100 px-8 py-2.5 text-black">취소</AlertDialogCancel>
          <AlertDialogAction onClick={onConfirm} className="rounded-md bg-redAccent px-8 py-2.5 text-white">
            삭제
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
